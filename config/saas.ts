...
export default {
  plans: [
    {
      productName: 'loghq Pro',
      description: 'Unlimited projects and errors, full history, and priority support.',
      pricing: [
        { key: 'loghq_pro_monthly', price: 1900, interval: 'month', currency: 'usd' },
        { key: 'loghq_pro_yearly', price: 19000, interval: 'year', currency: 'usd' },
      ],
      metadata: { createdBy: 'loghq', version: '1.0.0' },
    },
  ],
