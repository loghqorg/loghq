...
Implemented in [`routes/logs.ts`](https://github.com/stacksjs/loghq/blob/main/routes/logs.ts);
per-field shaping rules live in
[`app/Logs/normalize.ts`](https://github.com/stacksjs/loghq/blob/main/app/Logs/normalize.ts).
...
and per-process otherwise (see
[`app/Errors/limits.ts`](https://github.com/stacksjs/loghq/blob/main/app/Errors/limits.ts)).
